...
Wazuh Manager collects logs from multiple agents.
...
Integrated VirusTotal API for automated malware hash verification.
...
5️⃣ Threat Intelligence Integration

Automated malware detection workflow using VirusTotal.
